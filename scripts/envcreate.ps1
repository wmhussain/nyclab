...
$dataset5 = "https://spektraazurelabs.blob.core.windows.net/azureanalytics/yellow_tripdata_2016-05.csv"
$dataset6 = "https://spektraazurelabs.blob.core.windows.net/azureanalytics/yellow_tripdata_2016-06.csv"
Invoke-WebRequest -Uri "$lab1" -OutFile "C:\Packages\yellow_tripdata_2016-01.csv"
Invoke-WebRequest -Uri "$lab1" -OutFile "C:\Packages\yellow_tripdata_2016-02.csv"
Invoke-WebRequest -Uri "$lab1" -OutFile "C:\Packages\yellow_tripdata_2016-03.csv"
Invoke-WebRequest -Uri "$lab1" -OutFile "C:\Packages\yellow_tripdata_2016-04.csv"
Invoke-WebRequest -Uri "$lab1" -OutFile "C:\Packages\yellow_tripdata_2016-05.csv"
Invoke-WebRequest -Uri "$lab1" -OutFile "C:\Packages\yellow_tripdata_2016-06.csv"
